...
The 'Azure_End_to_End_Databricks_Project' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/Azure_End_to_End_Databricks_Project/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] Azure_End_to_End_Databricks_Project_etl` to your workspace.
